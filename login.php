...
<div>
    ...
    if (isset($_POST["login"])) {
        ...
        if ($user) {
            ...
            echo "<div class='alert alert-danger'>Invalid email or password. Please try again. Password requires an uppercase, lowercase, 
    ...
    <form action="login.php" method="post">
        <div class="container">
            <div class="row">
                <div class="col-5.5">
                    <h1>Login</h1>
                    <p>Please provide your login credentials to access your account:</p>
                    <hr class="mb-2">
